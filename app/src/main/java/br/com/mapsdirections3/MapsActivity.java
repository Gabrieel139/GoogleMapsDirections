package br.com.mapsdirections3;
...
import br.com.mapsdirections3.databinding.ActivityMapsBinding;
 ...
 //           mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    private void direction(){
        ...
        String url = Uri.parse("https://maps.googleapis.com/maps/api/directions/json")
                ...
                .appendQueryParameter("key", "AIzaSyCaok87XO80pTRe27rfj6_2jAFwmO5C-mw")
                .toString();
